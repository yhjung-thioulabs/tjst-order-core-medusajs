import { AddPriceListPricesDTO, AddPricesDTO, AddRulesDTO, CalculatedPriceSet, CreateMoneyAmountDTO, CreatePriceListDTO, CreatePriceListRuleDTO, CreatePriceRuleDTO, CreatePriceSetDTO, CreatePriceSetMoneyAmountRulesDTO, CreateRuleTypeDTO, FilterableMoneyAmountProps, FilterablePriceListProps, FilterablePriceListRuleProps, FilterablePriceRuleProps, FilterablePriceSetMoneyAmountProps, FilterablePriceSetMoneyAmountRulesProps, FilterablePriceSetProps, FilterableRuleTypeProps, MoneyAmountDTO, PriceListDTO, PriceListRuleDTO, PriceRuleDTO, PriceSetDTO, PriceSetMoneyAmountDTO, PriceSetMoneyAmountRulesDTO, PricingContext, PricingFilters, RemovePriceListRulesDTO, RemovePriceSetRulesDTO, RuleTypeDTO, SetPriceListRulesDTO, UpdateMoneyAmountDTO, UpdatePriceListDTO, UpdatePriceListPricesDTO, UpdatePriceListRuleDTO, UpdatePriceRuleDTO, UpdatePriceSetDTO, UpdatePriceSetMoneyAmountRulesDTO, UpdateRuleTypeDTO } from "./common";
...
export interface IPricingModuleService extends IModuleService {
     ...
     * ```
     */
    listPriceSetMoneyAmounts(filters?: FilterablePriceSetMoneyAmountProps, config?: FindConfig<PriceSetMoneyAmountDTO>, sharedContext?: Context): Promise<PriceSetMoneyAmountDTO[]>;
    /**
     ...
     * ```
     */
    listAndCountPriceSetMoneyAmounts(filters?: FilterablePriceSetMoneyAmountProps, config?: FindConfig<PriceSetMoneyAmountDTO>, sharedContext?: Context): Promise<[PriceSetMoneyAmountDTO[], number]>;
    /**
