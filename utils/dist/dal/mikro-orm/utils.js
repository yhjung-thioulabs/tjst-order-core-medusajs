...
var mikroOrmSerializer = function (data, options) { return __awaiter(void 0, void 0, void 0, function () {
    var data_, forSerialization, notForSerialization, serialize, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                options !== null && options !== void 0 ? options : (options = {});
                data_ = (Array.isArray(data) ? data : [data]).filter(Boolean);
                forSerialization = [];
                notForSerialization = [];
            ...
            case 1:
                ...
                result = serialize(forSerialization, __assign({ forceObject: true, populate: true }, options));
