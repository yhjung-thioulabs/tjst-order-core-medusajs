...
var writeMethods = ["delete", "softDelete", "restore"];
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            promises = [];
                            try {
                                for (_b = __values(Object.keys(groupedEvents)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    group = _c.value;
                                    promises.push((_a = this.eventBusModuleService_) === null || _a === void 0 ? void 0 : _a.emit(groupedEvents[group]));
                                }
                            }
