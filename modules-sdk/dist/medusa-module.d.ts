...
export declare class MedusaModule {
    ...
    static bootstrap<T>({ moduleKey, defaultPath, declaration, moduleExports, sharedContainer, moduleDefinition, injectedDependencies, migrationOnly, loaderOnly, }: ModuleBootstrapOptions): Promise<{
        [key: string]: T;
    }>;
