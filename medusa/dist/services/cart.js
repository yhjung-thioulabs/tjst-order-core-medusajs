                            ...
                            return __generator(this, function (_j) {
                                switch (_j.label) {
                                    case 0:
                                        ...
                                        rawCart = {
                                            context: (_g = data.context) !== null && _g !== void 0 ? _g : {},
                                        };
                                    ...
                                    case 1:
                                        _a.sales_channel_id = (_j.sent()).id;
                                        _j.label = 2;
                                    case 2:
                                        if (!(data.customer_id || data.customer)) return [3 /*break*/, 7];
                                        if (!((_h = data.customer) !== null && _h !== void 0)) return [3 /*break*/, 3];
                                        _b = _h;
                                        return [3 /*break*/, 6];
                                    case 3:
                                        _c = data.customer_id;
                                    ...
                                    case 18:
                                        ...
                                        return [4 /*yield*/, this.getValidatedSalesChannel(data.sales_channel_id)];
                                    case 19:
                                        salesChannel = _j.sent();
                                        return [4 /*yield*/, this.remoteLink_.create((_f = {},
                                                _f[modules_sdk_1.Modules.CART] = {
                                                    cart_id: cart.id,
                                                },
                                                _f[modules_sdk_1.Modules.SALES_CHANNEL] = {
                                    ...
                                    case 20:
                                        _j.sent();
                                        _j.label = 21;
                                    case 21: return [4 /*yield*/, this.eventBus_
                                            .withTransaction(transactionManager)
                    ...
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_j) {
                                switch (_j.label) {
                                    ...
                                    case 3:
                                        cart = _a;
                                        originalCartCustomer = __assign({}, ((_d = cart.customer) !== null && _d !== void 0 ? _d : {}));
                                    ...
                                    case 9:
                                        ...
                                        shippingAddress_1 = typeof data.shipping_address !== "string"
                                            ...
                                            : {};
                                        countryCode = (_e = (data.country_code || (shippingAddress_1 === null || shippingAddress_1 === void 0 ? void 0 : shippingAddress_1.country_code))) !== null && _e !== void 0 ? _e : null;
                                    ...
                                    case 11:
                                        ...
                                        billingAddress = (_f = data.billing_address_id) !== null && _f !== void 0 ? _f : data.billing_address;
                                    ...
                                    case 12:
                                        ...
                                        _j.label = 13;
                                    case 13:
                                        shippingAddress = (_g = data.shipping_address_id) !== null && _g !== void 0 ? _g : data.shipping_address;
                                    ...
                                    case 15:
                                        if (!(this.featureFlagRouter_.isFeatureEnabled(sales_channels_1.default.key) &&
                                            ...
                                            data.sales_channel_id != cart.sales_channel_id)) return [3 /*break*/, 22];
                                        return [4 /*yield*/, this.getValidatedSalesChannel(data.sales_channel_id)];
                                    case 16:
                                        salesChannel = _j.sent();
                                    ...
                                    case 17:
                                        _j.sent();
                                        if (!this.featureFlagRouter_.isFeatureEnabled(utils_1.MedusaV2Flag.key)) return [3 /*break*/, 21];
                                        if (!cart.sales_channel_id) return [3 /*break*/, 19];
                                        return [4 /*yield*/, this.remoteLink_.dismiss((_b = {},
                                                _b[modules_sdk_1.Modules.CART] = {
                                                    cart_id: cart.id,
                                                },
                                                _b[modules_sdk_1.Modules.SALES_CHANNEL] = {
                                    ...
                                    case 18:
                                        _j.sent();
                                        _j.label = 19;
                                    case 19: return [4 /*yield*/, this.remoteLink_.create((_c = {},
                                            _c[modules_sdk_1.Modules.CART] = {
                                                cart_id: cart.id,
                                            },
                                            _c[modules_sdk_1.Modules.SALES_CHANNEL] = {
                                                sales_channel_id: salesChannel.id,
                                            },
                                            _c))];
                                    case 20:
                                    ...
                                    case 21:
                                        ...
                                        _j.label = 22;
                                    case 22:
                                        if (!((0, utils_1.isDefined)(data.discounts) && data.discounts.length)) return [3 /*break*/, 28];
                                    ...
                                    case 23:
                                        ...
                                        if (!(previousDiscounts.some(function (_a) {
                                            ...
                                            !hasFreeShipping)) return [3 /*break*/, 25];
                                        return [4 /*yield*/, this.adjustFreeShipping_(cart, false)];
                                    case 24:
                                        _j.sent();
                                        _j.label = 25;
                                    case 25:
                                        if (!hasFreeShipping) return [3 /*break*/, 27];
                                    ...
                                    case 28:
                                        if (!((0, utils_1.isDefined)(data.discounts) && !data.discounts.length)) return [3 /*break*/, 30];
                                        cart.discounts.length = 0;
                                        return [4 /*yield*/, this.refreshAdjustments_(cart)];
                                    case 29:
                                        _j.sent();
                                        _j.label = 30;
                                    case 30:
                                        if (!("gift_cards" in data)) return [3 /*break*/, 32];
                                        cart.gift_cards = [];
                                        return [4 /*yield*/, (0, utils_1.promiseAll)(((_h = data.gift_cards) !== null && _h !== void 0 ? _h : []).map(function (_a) {
                                                var code = _a.code;
                                    ...
                                    case 33:
                                        ...
                                        if (!((data.email && data.email !== originalCartCustomer.email) ||
                                            (data.customer_id && data.customer_id !== originalCartCustomer.id))) return [3 /*break*/, 35];
                                        return [4 /*yield*/, this.eventBus_
                                                .withTransaction(transactionManager)
                                    ...
                                    case 34:
                                        _j.sent();
                                        _j.label = 35;
                                    case 35: return [4 /*yield*/, this.eventBus_
                                            .withTransaction(transactionManager)
                                            .emit(CartService.Events.UPDATED, updatedCart)];
                                    case 36:
                                        _j.sent();
