...
var loadMedusaApp = function (_a, config) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var featureFlagRouter, isMedusaV2Enabled, injectedDependencies, sharedResourcesConfig, configModules, _b, _c, moduleKey, medusaApp, requiredModuleKeys, missingPackages, requiredModuleKeys_1, requiredModuleKeys_1_1, requiredModuleKey, isModuleInstalled, _d, _e, _f, serviceKey, moduleService, _g, _h, moduleDefinition;
        var _j, e_2, _k, e_3, _l, e_4, _m, e_5, _o;
        var _p;
        var _q;
        return __generator(this, function (_r) {
            switch (_r.label) {
                case 0:
                    ...
                    injectedDependencies = (_j = {},
                        _j[utils_2.ContainerRegistrationKeys.PG_CONNECTION] = container.resolve(utils_2.ContainerRegistrationKeys.PG_CONNECTION),
                        _j);
                    ...
                    try {
                        ...
                        for (_b = __values(Object.keys(configModules)), _c = _b.next(); !_c.done; _c = _b.next()) {
                            ...
                            if ((0, utils_2.isObject)(configModules[moduleKey])) {
                                ;
                                (_p = (_q = configModules[moduleKey]).options) !== null && _p !== void 0 ? _p : (_q.options = {
                                    database: {
                                        type: "postgres",
                ...
                case 1:
                    ...
                    if (isMedusaV2Enabled) {
                        try {
                            ...
                            try {
                                if (requiredModuleKeys_1_1 && !requiredModuleKeys_1_1.done && (_l = requiredModuleKeys_1.return)) _l.call(requiredModuleKeys_1);
                            }
                    ...
                    container.register(utils_2.ContainerRegistrationKeys.REMOTE_LINK, (0, awilix_1.asValue)(medusaApp.link));
                    ...
                    try {
                        ...
                        for (_g = __values(Object.values(modules_sdk_1.ModulesDefinition)), _h = _g.next(); !_h.done; _h = _g.next()) {
                            moduleDefinition = _h.value;
