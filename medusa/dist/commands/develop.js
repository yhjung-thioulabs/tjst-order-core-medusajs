...
function default_1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var args, argv, COMMAND_INITIATED_BY, cliPath, child, _b, cli, binExists, backendUrl, adminChild_1;
        return __generator(this, function (_c) {
            ...
            _b = (0, resolve_admin_cli_1.resolveAdminCLI)(), cli = _b.cli, binExists = _b.binExists;
            if (binExists) {
                backendUrl = "http://localhost:".concat(port);
                adminChild_1 = (0, child_process_1.fork)(cli, ["develop", "--backend", "".concat(backendUrl)], {
                    cwd: directory,
                    env: process.env,
