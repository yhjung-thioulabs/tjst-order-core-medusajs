...
var ensureCurrencies = function (container) { return __awaiter(void 0, void 0, void 0, function () {
    var currenciesService, pricingModuleService, _a, coreCurrencies, totalCurrencies, moduleCurrencies, moduleCurrenciesSet, currenciesToCreate;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                currenciesService = container.resolve("currencyService");
                pricingModuleService = container.resolve("pricingModuleService");
                return [4 /*yield*/, currenciesService.listAndCount({}, {})];
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 2]), coreCurrencies = _a[0], totalCurrencies = _a[1];
                return [4 /*yield*/, pricingModuleService.listCurrencies({}, { take: 100000 })];
            case 2:
                moduleCurrencies = _b.sent();
                moduleCurrenciesSet = new Set(moduleCurrencies.map(function (_a) {
                    var code = _a.code;
                    return code;
                }));
                currenciesToCreate = coreCurrencies
                    .filter(function (_a) {
                    var code = _a.code;
                    return !moduleCurrenciesSet.has(code);
                })
                    .map(function (_a) {
                    var includes_tax = _a.includes_tax, currency = __rest(_a, ["includes_tax"]);
                    return currency;
                });
                return [4 /*yield*/, pricingModuleService.createCurrencies(currenciesToCreate)];
            case 3:
                _b.sent();
                return [2 /*return*/];
        }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    logger_1.default.info("------------- Creating currencies -------------");
                    logger_1.default.info("-----------------------------------------------");
                    return [4 /*yield*/, ensureCurrencies(container)];
                case 2:
                    _b.sent();
                    logger_1.default.info("-----------------------------------------------");
