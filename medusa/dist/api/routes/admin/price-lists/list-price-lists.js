...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var featureFlagRouter, validated, priceLists, count, priceListService;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, modules_queries_1.listAndCountPriceListPricingModule)({
                        filters: req.filterableFields,
                        listConfig: req.listConfig,
                        container: req.scope,
                    })];
            case 1:
                _a = __read.apply(void 0, [_c.sent(), 2]), priceLists = _a[0], count = _a[1];
                return [3 /*break*/, 4];
            case 2:
