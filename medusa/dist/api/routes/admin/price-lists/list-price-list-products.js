...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, offset, limit, featureFlagRouter, products, count, priceListService, filterableFields;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                ;
                return [4 /*yield*/, (0, utils_2.listProducts)(req.scope, filterableFields, req.listConfig)];
            case 1:
                _b = __read.apply(void 0, [_d.sent(), 2]), products = _b[0], count = _b[1];
                return [3 /*break*/, 4];
            case 2:
                ;
            ...
            case 3:
                _c = __read.apply(void 0, [_d.sent(), 2]), products = _c[0], count = _c[1];
                _d.label = 4;
            case 4:
                res.json({
                    products: products,
