...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, priceList, featureFlagRouter, manager, priceListService, validated, updatePriceListWorkflow, input;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                updatePriceListWorkflow = (0, core_flows_1.updatePriceLists)(req.scope);
                input = {
                    price_lists: [
                        __assign({ id: id }, validated),
                    ],
                };
                return [4 /*yield*/, updatePriceListWorkflow.run({
                        input: input,
                        context: {
                            manager: manager,
                        },
