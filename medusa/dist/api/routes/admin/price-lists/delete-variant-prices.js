...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, variant_id, priceListService, featureFlagRouter, manager, isMedusaV2FlagEnabled, deletedPriceIds, deletePriceListProductsWorkflow, input, result, _b, deletedIds;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                deletePriceListProductsWorkflow = (0, core_flows_1.removePriceListVariantPrices)(req.scope);
                input = {
