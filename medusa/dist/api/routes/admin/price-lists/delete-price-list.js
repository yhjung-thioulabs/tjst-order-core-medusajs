...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, featureFlagRouter, manager, isMedusaV2FlagEnabled, removePriceListsWorkflow, input, priceListService_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                removePriceListsWorkflow = (0, core_flows_1.removePriceLists)(req.scope);
                input = {
                    price_lists: [id],
                };
                return [4 /*yield*/, removePriceListsWorkflow.run({
                        input: input,
                        context: {
                            manager: manager,
                        },
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2:
                priceListService_1 = req.scope.resolve("priceListService");
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, priceListService_1.withTransaction(transactionManager).delete(id)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
