...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var priceListService, manager, featureFlagRouter, priceList, isMedusaV2FlagEnabled, createPriceListWorkflow, validatedInput, rules, customerGroups, input, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                createPriceListWorkflow = (0, core_flows_1.createPriceLists)(req.scope);
                validatedInput = req.validatedBody;
                rules = {};
                customerGroups = (validatedInput === null || validatedInput === void 0 ? void 0 : validatedInput.customer_groups) || [];
                delete validatedInput.customer_groups;
                if (customerGroups.length) {
                    rules["customer_group_id"] = customerGroups.map(function (cg) { return cg.id; });
                }
                input = {
                    price_lists: [
                        __assign(__assign({}, validatedInput), { rules: rules }),
                    ],
                };
                return [4 /*yield*/, createPriceListWorkflow.run({
                        input: input,
                        context: {
                            manager: manager,
                        },
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, modules_queries_1.getPriceListPricingModule)(priceList.id, {
                        container: req.scope,
                    })];
            case 2:
                priceList = _a.sent();
